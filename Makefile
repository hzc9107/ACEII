...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Mon Dec 16 22:43:29 2013
# Project:  AceVal.pro
# Template: app
...
$(TARGET): ui_aceval.h ui_scenedialog.h ui_playerdialog.h ui_playerscontrol.h ui_dbconnection.h ui_newdb.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/AceVal1.0.0/ && $(COPY_FILE) --parents aceval.h pipeline.h scene.h scenedialog.h player.h playerdialog.h playerscontrol.h dbconnection.h newdb.h dbthread.h .tmp/AceVal1.0.0/ && $(COPY_FILE) --parents main.cpp aceval.cpp pipeline.cpp scenedialog.cpp playerdialog.cpp playerscontrol.cpp dbconnection.cpp newdb.cpp dbthread.cpp .tmp/AceVal1.0.0/ && $(COPY_FILE) --parents aceval.ui scenedialog.ui playerdialog.ui playerscontrol.ui dbconnection.ui newdb.ui .tmp/AceVal1.0.0/ && (cd `dirname .tmp/AceVal1.0.0` && $(TAR) AceVal1.0.0.tar AceVal1.0.0 && $(COMPRESS) AceVal1.0.0.tar) && $(MOVE) `dirname .tmp/AceVal1.0.0`/AceVal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/AceVal1.0.0
...
compiler_moc_header_make_all: moc_aceval.cpp moc_scenedialog.cpp moc_playerdialog.cpp moc_playerscontrol.cpp moc_dbconnection.cpp moc_newdb.cpp moc_dbthread.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_aceval.cpp moc_scenedialog.cpp moc_playerdialog.cpp moc_playerscontrol.cpp moc_dbconnection.cpp moc_newdb.cpp moc_dbthread.cpp
...
compiler_uic_make_all: ui_aceval.h ui_scenedialog.h ui_playerdialog.h ui_playerscontrol.h ui_dbconnection.h ui_newdb.h
compiler_uic_clean:
	-$(DEL_FILE) ui_aceval.h ui_scenedialog.h ui_playerdialog.h ui_playerscontrol.h ui_dbconnection.h ui_newdb.h
